...
import img5 from '../images/portfolio-image-7.jpg'
          ...
          <motion.div 
            ...
            >
              ...
              <motion.div 
                ...
                whileInView={'show'}
                viewport={{once: true, amount: 0.3}}
                className='flex-1 flex flex-col gap-y-[34px]'
              >
              <div className='group relative overflow-hidden  border-2 border-black rounded-xl'>
                ...
                <div className='group relative overflow-hidden  border-2 border-black rounded-xl'>
                  ...
                  <img className='group-hover:scale-125 transition-all duration-500' src={img5} alt='' />
                    ...
                    <div className='absolute -bottom-full left-6 lg:left-12 group-hover:bottom-7 transition-all duration-700 z-50'>
                      <span className='text-2xl lg:text-3xl text-white'>SuperWheels<br/>Car Dealership</span>
                    </div>
